...
<head>
    <title>
        <?php echo e(\App\Models\Utility::getValByName('title_text') ? \App\Models\Utility::getValByName('title_text') : config('app.name', 'HR Tool')); ?>
    ...
    <meta property="og:image"
        content="<?php echo e(isset($meta_logo) && !empty(asset('storage/uploads/meta/' . $meta_logo)) ? asset('storage/uploads/meta/' . $meta_logo) : 'hr.png'); ?>">
    ...
    <meta name="author" content="Hr Tool" />
    ...
    <div class="custom-login">
        <div class="login-bg-img">
            ...
            <?php if(strpos($themeColor, 'theme') === 0): ?>
                <img src="<?php echo e(asset('assets/images/' . $themeColor . '.png')); ?>" class="login-bg-1">
            <?php else: ?>
                <img src="<?php echo e(asset('assets/images/.svg')); ?>" class="login-bg-1">
            <?php endif; ?>

            <img src="<?php echo e(asset('assets/images/hr-01.jpg')); ?>" class="login-bg-2">
        </div>
        <div class="bg-login bg-info"></div>
        <div class="custom-login-inner">
                    ...
                    <div class="container">
                        <div class="navbar-brand">
                            <a href="#">
                                <img src="<?php echo e($logo . '/' . (isset($company_logo) && !empty($company_logo) ? $company_logo . '?' . time() : 'logo_dark.png' . '?' . time())); ?>"
                                    class="logo" alt="<?php echo e(config('app.name', 'HR Tool')); ?>" alt="logo"
                       ...
                       <div class="collapse navbar-collapse" id="navbarlogin">
                            <ul class="navbar-nav align-items-center ms-auto mb-2 mb-lg-0">
                               <h5 style="color:gray; font-size:20px" >จัดการบัญชีเงินเดือนและค่าจ้างของพนักงาน บันทึกประวัติ เวลาเข้าทำงาน</h5>
                            </ul>
                        </div>
                    </div>
                </nav>
            ...
            <main class="custom-wrapper">
                <div class="custom-row">
                   ...
                   <p class="my-4 text-center"><b> Demo: company@example.com  - password: test12345</b></p>
					</div>
                </div>
            </main>
            <footer>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <span>
                                    ...
                                    <?php endif; ?>
                                    <?php echo e(App\Models\Utility::getValByName('footer_text') ? App\Models\Utility::getValByName('footer_text') : config('app.name', 'HR Tool')); ?>
...
<?php /**PATH C:\app_pos\www\hr_tool\resources\views/layouts/auth.blade.php ENDPATH**/ ?>