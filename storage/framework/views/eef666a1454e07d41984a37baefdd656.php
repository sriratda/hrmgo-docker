 ...
 <!--   <?php if($plan->enable_chatgpt == 'on'): ?>
    ...
    <div class="row">
        ...
        <div class="form-group col-md-6">
            ...
            <?php echo e(Form::select('type', $otherpaytype, null, ['class' => 'form-control amount_type','required' => 'required'])); ?>
...
<?php /**PATH C:\app_pos\www\hr_tool\resources\views/otherpayment/create.blade.php ENDPATH**/ ?>