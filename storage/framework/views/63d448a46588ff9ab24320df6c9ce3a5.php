    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <?php echo e(Form::select('type', $otherpaytypes, null, ['class' => 'form-control amount_type', 'required' => 'required'])); ?>
...
<?php /**PATH C:\app_pos\www\hr_tool\resources\views/otherpayment/edit.blade.php ENDPATH**/ ?>